...
all: wrappers handlers
	...
	${CC} -g -o client ${APP}/ClientApplication.cpp ${OBJ}/ClientSyncWrapper.o ${OBJ}/ClientSocketWrapper.o ${OBJ}/SocketWrapper.o ${OBJ}/PacketHandler.o ${OBJ}/FileHandler.o -pthread
